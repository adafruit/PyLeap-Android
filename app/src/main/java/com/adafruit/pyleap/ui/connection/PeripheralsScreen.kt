...
import com.adafruit.pyleap.ui.components.InputTextActionDialog
import com.adafruit.pyleap.ui.theme.PeripheralsScanControlsOutline
import com.adafruit.pyleap.ui.theme.ProjectCardBackground
import com.adafruit.pyleap.ui.theme.PyLeapTheme
import com.adafruit.pyleap.ui.theme.WarningBackground
...
@Composable
private fun PeripheralsBackground(
    modifier: Modifier = Modifier,
...
@Preview
@Composable
private fun PeripheralNameWaitPreview() {
    PyLeapTheme {
        PeripheralsBackground {
